...
function getActualSourcesForContract(sources: Record<string, any> | undefined, contractName: string) {
  if (!sources) return [];
...
function getInheritedFunctions(sources: Record<string, any> | undefined, contractName: string) {
